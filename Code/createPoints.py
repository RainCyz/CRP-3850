...
# last modified by Yucheng Zhang, fulfilling the Term Project for CRP 3850
# We filtered out undesirable, inaccessible points on the highways and within tunnels
...
if __name__ == "__main__":
    ...
    inshp = os.path.join(root,'NYC_ROADS.shp')
    outshp = os.path.join(root,'NYC_DOTS_200m.shp')
