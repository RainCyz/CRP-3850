...
# last modified by Yucheng Zhang, being used to fulfill the final Project for CRP 3850
...
def gsv(samplesFeatureClass,num,ouputTextFolder,year):
    '''
    ...
    for b in range(batch):
        ...
        time.sleep(0.01)
        #sleep to avoid overflooding the API
        #sleep less, as an AAP student
...
if __name__ == "__main__":
    ...
    root = 'D:\\2022 Spring\\CRP 3850\\CRP-3850\\Green View Index\\FULL'
    inputShp = os.path.join(root,'NYC_DOTS_CLEANED_200m.shp')
    outputTxt = 'D:\\2022 Spring\\CRP 3850\\CRP-3850\\Green View Index\\FULL\\pano_txt'
    year = 2018 #only collect after 2018, to in consistent with the tree data

    gsv(inputShp,1000,outputTxt,year)
